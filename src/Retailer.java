...
public class Retailer {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElement(By.name("Email")).sendKeys("IL60@mailinator.com");
		driver.findElement(By.id("password")).sendKeys("Rogers$1");
		driver.findElement(By.xpath("//*[@id=\"account\"]/div/div/div[7]/button")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"maincontainer\"]/div/div[1]/div[2]/div/div[3]/div/div[1]/div/div[2]/p/a")).click();
		Thread.sleep(2000);
